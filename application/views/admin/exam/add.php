        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form" action="<?= base_url('Admin/ExamSchedule/store/'.$student_id)?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="text" id="end_time" min="<?php echo date("Y-m-d")?>" name="end_time" value="<?= set_value('end_time')?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Table No</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="table_no" name="table_no" value="<?= set_value('table_no')?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
