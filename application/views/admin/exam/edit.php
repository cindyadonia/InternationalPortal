                ...
                <div class="card-body">
                    ...
                    <form class="form" action="<?= base_url('Admin/ExamSchedule/update/'.$exam['id'])?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="text" id="location" name="location" value="<?= $exam['location']?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Date</label>
                            <div class="col-10">
                                <input class="form-control" type="date" id="date" name="date" value="<?= $exam['date']?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Start Time</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="start_time" name="start_time" value="<?= $exam['start_time']?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">End Time</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="end_time" name="end_time" value="<?= $exam['end_time']?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Table No</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="table_no" name="table_no" value="<?= $exam['table_no']?>">
                            </div>
                        </div>
                        <div class="form-group row">
