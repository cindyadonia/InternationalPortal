        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form" action="<?= base_url('timetable/update/'.$schedule['id'])?>" method="POST">
                        <div class="form-group mt-4 row">
                            <label for="example-text-input" class="col-2 col-form-label">Subject</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="subject" name="subject" value="<?= $schedule['name'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Credits</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="credits" name="credits" value="<?= $schedule['credits'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-datetime-local-input" class="col-2 col-form-label">Lecturer</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="lecturer" name="lecturer" value="<?= $schedule['lecturer'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-datetime-local-input" class="col-2 col-form-label">Class</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="class" name="class" value="<?= $schedule['class'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-datetime-local-input" class="col-2 col-form-label">Location</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="location" name="location" value="<?= $schedule['location'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Day</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="day" name="day" value="<?= $schedule['day'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">Start Time</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="start_time" name="start_time" value="<?= $schedule['start_time'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label">End Time</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="end_time" name="end_time" value="<?= $schedule['end_time'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
